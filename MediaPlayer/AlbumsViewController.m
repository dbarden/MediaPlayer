...
//    self.title = self.artist;
    MPMediaPropertyPredicate *artistNamePredicate = [MPMediaPropertyPredicate predicateWithValue:self.artist forProperty:MPMediaItemPropertyArtist];
    ...
    for (MPMediaItemCollection *collection in artistCollections){
        ...
        if ([[item valueForProperty:MPMediaItemPropertyMediaType] isEqualToNumber:[NSNumber numberWithInt:MPMediaTypeMusic]]){
            ...
            NSLog(@"Artist name: %@",[item valueForProperty:MPMediaItemPropertyAlbumTitle]);
            [tmp addObject:albumName];
        }
    }
    self.albums = tmp;
    
    [tmp release];
    NSLog(@"List of artists %@", self.albums);
